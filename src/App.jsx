...
export default () => (
  <div className="App">
    ...
    <div className="Cards">
      <Card titulo="#13 - Mega" color="#8DBB77">
        <Mega qtde={10}></Mega>
      </Card>

      <Card titulo="#12 - Contador" color="#8CAA46">
        <Contador numeroInicial={0} passoInicial={5}></Contador>
      </Card>

      <Card titulo="#11 - Componente Controlado (Input)" color="#46AA72">
        <Input></Input>
      </Card>
